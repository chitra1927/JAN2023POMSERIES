	...
	public class Register {
		...
		public String registerUser(String firstName, String lastName, 
			...
			eleUtil.waitForElementVisibility(this.firstName, AppConstants.MEDIUM_DEFAULT_WAIT);
			...
			String userRegSuccessMesg = 
					eleUtil.waitForElementVisibility(userRegSuccMessg, AppConstants.MEDIUM_DEFAULT_WAIT).getText();
